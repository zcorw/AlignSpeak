export default {
  translation: {
    ...
    articleTts: {
      entry: {
        prepare: 'Loop full article',
        active: 'In player',
      },
      confirmSwitchTitle: 'Switch article audio',
      confirmSwitchMessage: 'The current full-article audio will stop. Prepare and switch to the new article?',
      switchAction: 'Stop and switch',
      largeDownloadTitle: 'Confirm data usage',
      largeDownloadMessage: 'This audio is estimated at {{size}}. Continue preparing it?',
      prepareAction: 'Continue',
      estimatedSize: 'Audio size{{qualifier}}: {{size}}',
      estimatedQualifier: ' (estimated)',
      preflightFailed: 'Unable to check the full-article audio. Please try again.',
      resume: {
        label: 'Resume previous full-article playback',
        title: 'Continue “{{title}}”',
        position: 'Last position {{position}} · manual restore required',
        action: 'Restore last position',
        dismiss: 'Discard last position',
      },
      policy: {
        action: 'Set loop or stop time',
        infinite: 'Loop indefinitely',
        endCurrent: 'Stop after this round',
        minutes: 'Stop after {{minutes}} minutes',
      },
      interruption: {
        'another-tab': 'Another tab took over · tap play to continue',
        recording: 'Recording paused full audio · tap play to continue',
        'segment-audio': 'Segment audio paused full audio · tap play to continue',
        'sentence-audio': 'Sentence audio paused full audio · tap play to continue',
        system: 'System or audio-device interruption · tap play to continue',
      },
      player: {
        label: 'Full-article audio player',
        progressLabel: 'Full-article audio preparation progress',
        untitled: 'Current article',
        checking: 'Checking the audio version…',
        preparing: 'Preparing full audio · {{completed}}/{{total}} segments',
        downloading: 'Downloading completely · {{loaded}} / {{total}}',
        unknownSize: 'unknown size',
        ready: 'Full article ready · tap play',
        playing: 'Playing full article',
        paused: 'Paused · tap to continue',
        stoppedBySleep: 'Sleep timer ended · stopped',
        stoppedAtEnd: 'Round completed · stopped',
        failed: 'Full-article audio preparation failed',
        failedSegment: 'Segment {{segment}} failed and was not skipped',
        retry: 'Retry failed task',
        play: 'Play full-article audio',
        pause: 'Pause full-article audio',
        update: 'Update full-article audio',
      },
    },
    pages: {
      start: {
