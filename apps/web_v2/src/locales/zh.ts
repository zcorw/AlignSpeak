export default {
  translation: {
    ...
    articleTts: {
      ...
      confirmSwitchTitle: '切换播放文章',
      confirmSwitchMessage: '当前文章的整篇音频将停止。确认准备并切换到新文章吗？',
      switchAction: '停止并切换',
      largeDownloadTitle: '确认使用蜂窝网络或流量',
      largeDownloadMessage: '预计需要下载 {{size}} 音频。确认继续准备吗？',
      prepareAction: '继续准备',
      estimatedSize: '音频大小{{qualifier}}：{{size}}',
      estimatedQualifier: '（预计）',
      preflightFailed: '无法检查整篇音频，请稍后重试。',
      resume: {
        label: '恢复上次整篇播放',
        title: '继续《{{title}}》',
        position: '上次位置 {{position}} · 需手动恢复',
        action: '恢复到上次位置',
        dismiss: '放弃上次位置',
      },
      policy: {
        ...
        infinite: '无限循环',
        endCurrent: '本轮结束后停止',
        minutes: '{{minutes}} 分钟后停止',
      },
      interruption: {
        'another-tab': '已由另一个标签页接管 · 请手动继续',
        recording: '录音已暂停整篇播放 · 请手动继续',
        'segment-audio': '单段朗读已暂停整篇播放 · 请手动继续',
        'sentence-audio': '单句朗读已暂停整篇播放 · 请手动继续',
        system: '播放被系统或外接设备中断 · 请手动继续',
      },
      player: {
        label: '整篇文章音频播放器',
        progressLabel: '整篇音频准备进度',
        untitled: '当前文章',
        checking: '正在检查音频版本…',
        preparing: '正在生成整篇音频 · {{completed}}/{{total}} 段',
        downloading: '正在完整下载 · {{loaded}} / {{total}}',
        unknownSize: '未知大小',
        ready: '全文已就绪 · 点击播放',
        playing: '正在整篇播放',
        paused: '已暂停 · 点击继续',
        stoppedBySleep: '定时已到 · 已停止',
        stoppedAtEnd: '本轮播放完成 · 已停止',
        failed: '整篇音频准备失败',
        failedSegment: '第 {{segment}} 段生成失败，未跳过',
        retry: '重试失败任务',
        play: '播放整篇音频',
        pause: '暂停整篇音频',
        update: '更新整篇音频',
    ...
    pages: {
      ...
      editor: {
        ...
        overlay: {
          ...
          segmentRuleHint: '空行会创建新段落，分段列表会实时更新。',
          segmentList: '段落列表 · {{count}}',
          segmentListEmpty: '输入文本后，这里会显示段号、字数和内容预览。',
          segmentChars: '{{count}} 字',
          segmentPreview: '段落预览',
